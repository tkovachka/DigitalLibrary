    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    BorrowedBookId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: true),
                    DateBorrowed = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    DateReturned = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    LibraryApplicationUserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Loans_AspNetUsers_LibraryApplicationUserId",
                        column: x => x.LibraryApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateRequested = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    ActivationDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_LibraryApplicationUserId",
                        column: x => x.LibraryApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Loans",
                column: "LibraryApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_LibraryApplicationUserId",
                table: "Reservations",
                column: "LibraryApplicationUserId");
        }
